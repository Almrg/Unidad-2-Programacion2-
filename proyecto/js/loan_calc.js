function mostrarVentana()
{
    ...
    ventana.style.marginTop = "50px"; // Definimos su posición vertical. La ponemos fija para simplificar el código
...
function show() {
	...
	/*output += "<table align='center' style='width:90%;margin:10px'> \
			...
			<td align='right'>"+numpay+"</td></tr><tr><td> Tasa anual:</td><td align='right'>"+(fixVal(anual,0,4,' '))*100+"%</td></tr> \
			<tr><td>Tasa mensual :</td><td align='right'>"+(fixVal(monthly,0,4,' '))*100+"%</td></tr><tr><td>Mensualidad:</td> \
